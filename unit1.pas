...
--------------------------------------------------------------------------------
 ...
 |  METHOD |  CODE 1  |  CODE 2  |  CODE 3  |  CODE 4  |  CODE 5  |  CODE 6   |
 |=========|==========|==========|==========|==========|==========|===========|
 |  Debug  | 32,9288  | 179,0486 |  0,3927  |  1,1459  |  1,6595  |  0,7231   |
 |---------|----------|----------|----------|----------|----------|-----------|
 | Release | 33,7899  | 175,9073 |  0,3314  |  0,9093  |  1,3172  |  0,6364   |
 |----------------------------------------------------------------------------|
 ...
 |  METHOD |  CODE 1  |  CODE 2  |  CODE 3  |  CODE 4  |  CODE 5  |  CODE 6   |
 |=========|==========|==========|==========|==========|==========|===========|
 |  Debug  |  9,6536  |  28,8853 |   N/A    |  2,5927  |  3,5188  |  2,2695   |
 |---------|----------|----------|----------|----------|----------|-----------|
 | Release | 10,0101  |  29,9593 |   N/A    |  2,2685  |  3,0899  |  2,0943   |
 |----------------------------------------------------------------------------|
    ...
    begin
      ...
      if (x>=0) and (x+s<=318) then
       begin
        ...
        mpc:=z shr 1;
        if (z<47) then z:=46;
        y := 100 + (zobs-z)*30 div iy1;  // Could be optimized with a distance compensation LUT
